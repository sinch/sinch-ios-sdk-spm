...
[![Platform](https://img.shields.io/badge/platform-iOS%2015%2B-blue.svg?style=flat)](https://developer.apple.com/ios/)
...
3. In the configuration view, choose one of the following Dependency Rules:
   ...
   - Version: select **Exact Version** and enter "5.45.12" — links the dynamic xcframework for that specific version
4. Click **Add Package**.
...
```swift
dependencies: [
    .package(url: "https://github.com/sinch/sinch-ios-sdk-spm.git", exact: "5.45.12"),
]
```
