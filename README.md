...
3. In the configuration view, choose one of the following Dependency Rules:
   ...
   - Version: select **Exact Version** and enter "5.46.4" — links the dynamic xcframework for that specific version
4. Click **Add Package**.
...
```swift
dependencies: [
    .package(url: "https://github.com/sinch/sinch-ios-sdk-spm.git", exact: "5.46.4"),
]
```
